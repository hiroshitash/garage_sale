...
exports.getListHTML = function(url, params, callback) {
  ...
  exports.get(url, function(response) {
    ...
    $('#toc_rows .row').each(function(index, element) {
      /*
       <p class="row" data-pid="4594142836"> 
    	 <a href="/sfc/fuo/4594142836.html" class="i" data-id="0:00G0G_8SlYtpgUVpx">
    	   <span class="price">&#x0024;70</span>
    	 </a> <span class="txt"> 
    	 <span class="star"></span> 
    	 <span class="pl"> <span class="date">Jul 29</span>  
    	   <a href="/sfc/fuo/4594142836.html">Full Bed Frame for sale</a> 
    	 </span> 
    	 <span class="l2"> 
    	   <span class="price">&#x0024;70</span>  
    	   <span class="pnr"> <small> (lower haight)</small> 
    	     <span class="px"> <span class="p"> pic&nbsp;
    	       <span class="maptag" data-pid="4594142836">map</span>
    	     </span>
    	   </span> 
    	 </span>  
    	 <a class="gc" href="/fuo/" data-cat="fuo">furniture - by owner</a> 
    	 </span> </span> 
       </p> 
      */
      element = $(element)
